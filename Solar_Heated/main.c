...
Estimate necessary solar collecting area size for particular type of
constructions in a given location.
*/
...
int main(void) {
    ...
    int heat_deg_days, // average for coldest month
        ...
        heating_req, /* BTU / degree day ft^2 requirement for given type
                        of construction
                    */
    ...
    hdd_file = fopen("inputs\\hdd.txt", "r");
    ...
    // Get the corresponding average daily solar insolation from other file
    solar_file = fopen("inputs\\solar.txt", "r");
...
/*
Given a month number (1 = January, 2 = Feb..... 12 = December), return the
...
/* Finds and returns the nth integer in a file.
   Pre: data_file access a file of at least n integers (n >= 1)
*/
